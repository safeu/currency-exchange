...
public class AppConstants {
    ...
    static {
        ...
        CURRENCY_NAMES.put("TRY", "TRY — Turkish Lira");
        CURRENCY_NAMES.put("PLN", "PLN — Polish Zloty");
        CURRENCY_NAMES.put("CZK", "CZK — Czech Koruna");
        CURRENCY_NAMES.put("HUF", "HUF — Hungarian Forint");
        CURRENCY_NAMES.put("RON", "RON — Romanian Leu");
        CURRENCY_NAMES.put("BGN", "BGN — Bulgarian Lev");
        CURRENCY_NAMES.put("ISK", "ISK — Icelandic Krona");
        CURRENCY_NAMES.put("ILS", "ILS — Israeli Shekel");
